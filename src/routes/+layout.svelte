...
{#if showBanner}
	<Banner closeButtonOnClick={() => (showBanner = false)}>
		<p class="text-xs md:text-sm/6 text-gray-900">
			Descubre las propiedades de <strong class="font-semibold">Inhaus</strong> en nuestra plataforma.
		</p>
		<a
			href="/publicaciones?exclusiveSeller=Inhaus"
			class="flex-none rounded-full bg-gray-900 px-3.5 py-1 text-xs md:text-sm font-semibold text-white shadow-xs hover:bg-gray-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
