<div class="relative mt-32 px-6 lg:px-8">
	...
	<div class="mx-auto max-w-2xl text-center">
		...
		<p class="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-600">
			Tu publicación será revisada por nuestro equipo para asegurarnos de que cumple con nuestras
			políticas de contenido. Podrás verificar el resultado de la revisión en tu panel de
			publicaciones. Toma en cuenta que este proceso puede tardar hasta 24 horas.
		</p>
